...
int GUIUser::chooseResource(Area *area)
{
    ...
    if (!medicBtnTexture.loadFromFile("../dalandTilesets/images/medicBtn.png"))
    {
        cout << "Texture missing" << endl;
    }
    sf::Sprite medicBtn;
    ...
    if (!ammoBtnTexture.loadFromFile("../dalandTilesets/images/ammoBtn.png"))
    {
        cout << "Texture missing" << endl;
    }
    sf::Sprite ammoBtn;
    ...
    if (!goodsBtnTexture.loadFromFile("../dalandTilesets/images/goodsBtn.png"))
    {
        cout << "Texture missing" << endl;
    }
    sf::Sprite goodsBtn;
...
void GUIUser::createCountries(Map *map, sf::RenderWindow *window)
{
    ...
    if (!confirmBtnTexture.loadFromFile("../dalandTilesets/images/endTurnBtn.png"))
    {
        cout << "Texture missing" << endl;
    }
...
int GUIUser::platoonType()
{
    ...
    if (!landPlatoonBtnTexture.loadFromFile("../dalandTilesets/images/landPlatoon.png"))
    {
        cout << "Texture missing" << endl;
    }
    ...
    if (!airPlatoonBtnTexture.loadFromFile("../dalandTilesets/images/airPlatoon.png"))
    {
        cout << "Texture missing" << endl;
    }
