...
Area::Area(string name, int index, int colour, bool factories, bool troops) : MapComponent()
{
	...
	else
	{
	 ...
	 if (!texture.loadFromFile("../Data/dalandTilesets/images/Factories_111.png"))
            {
...
void Area::setFactoryTexture(){
	string out="../Data/dalandTilesets/images/Factories_"+to_string(allFactories[0]!=NULL)+to_string(allFactories[1]!=NULL)+to_string(allFactories[2]!=NULL)+".png";
