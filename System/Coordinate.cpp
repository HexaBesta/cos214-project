...
Coordinate::Coordinate(int x, int y, int colour,Area* area,int scaleX,int scaleY)
    {
        ...
        if (colour == 22)
        {
            ...
            if (!texture.loadFromFile("../Data/dalandTilesets/images/DesertTile_370_22_.png"))
            {
        ...
        {
            if (!texture.loadFromFile("../Data/dalandTilesets/images/DesertTile_370_160_.png"))
            {
                cout << "Texture missing" << endl;
            }
        }
        ...
        {
            if (!texture.loadFromFile("../Data/dalandTilesets/images/WaterTile_.png"))
            {
                cout << "Texture missing" << endl;
            }
        }
        ...
        {
            if (!texture.loadFromFile("../Data/dalandTilesets/images/DesertTile_370_94_.png"))
            {
                cout << "Texture missing" << endl;
            }
        }
    ...
    void Coordinate::setTextureBorders(string borders, int colour, bool terrain)
    {
        if (!terrain)
        {
	        ...
	        this->texture.update(*(im->findTexture("../Data/dalandTilesets/images/DesertTile_370_" + to_string(colour) + "_" + borders + ".png")));
        }
        else
        {
            ImageLibrary* im = ImageLibrary::getInstance();
	        this->texture.update(*(im->findTexture("../Data/dalandTilesets/images/WaterTile_" + borders + ".png")));
        }
