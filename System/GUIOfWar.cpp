...
void GUIOfWar::initUI(vector<sf::Drawable *> &ui)
{
    ...
    if (!destroyRouteBtnTexture->loadFromFile("../Data/dalandTilesets/images/destroyRouteBtn.png"))
    {
        cout << "Texture missing" << endl;
    }
    ...
    if (!recruitBtnTexture->loadFromFile("../Data/dalandTilesets/images/landPlatoon.png"))
    {
        cout << "Texture missing" << endl;
    }
    ...
    if (!inspectBtnTexture->loadFromFile("../Data/dalandTilesets/images/inspectBtn.png"))
    {
        cout << "Texture missing" << endl;
    }
